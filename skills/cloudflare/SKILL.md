---
name: cloudflare
description: This skill should be used when the user asks to "create Worker", "deploy to Pages", "configure KV", "setup D1", "manage R2 bucket", "configure WAF", "setup Tunnel", or mentions Cloudflare Workers, Pages, storage, AI, networking, security, or infrastructure-as-code for Cloudflare.
---
...
Reference files are available in the `references/` subdirectory of this skill.
