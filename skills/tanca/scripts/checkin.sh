#!/bin/bash
# Record check-in for an employee shift
# Usage: ./checkin.sh <employee_shift_id> [reason]
...
if [ -z "$1" ]; then
  ...
  echo "Example: $0 678abc123def456789012345 'Manual check-in'" >&2
  exit 1
fi
